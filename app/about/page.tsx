...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen w-full bg-white">
      <Navbar />
      <div className="hidden md:flex flex-1 items-center justify-center min-h-screen w-full">
        <section className="w-full flex flex-col md:flex-row items-center md:items-center px-4 pt-24 md:pt-36 md:pb-16 md:gap-12 md:justify-center md:h-auto">
          {/* Photo */}
          <div className="w-32 h-32 md:w-96 md:h-96 rounded-full overflow-hidden bg-white shadow-lg mt-2 mb-2 md:mt-0 md:mb-0 md:mr-12 flex-shrink-0 flex items-center justify-center">
            <Image src="/Kirit_Singh-orange-portait.png" alt="Kirit Singh" width={828} height={828} className="object-cover w-full h-full" />
          </div>
          {/* Text */}
          <div className="flex flex-col items-center md:items-start max-w-2xl w-full justify-center">
            ...
            <p className="mb-2 md:mb-6 text-sm md:text-2xl text-black text-center md:text-left">
            ...
            <p className="mb-0 text-sm md:text-2xl text-black text-center md:text-left">
      ...
      {/* Mobile version */}
      <section className="w-full flex flex-col md:hidden items-center px-4 pt-24">
        {/* Photo */}
        <div className="w-32 h-32 rounded-full overflow-hidden bg-white shadow-lg mt-2 mb-2 flex-shrink-0 flex items-center justify-center">
          <Image src="/Kirit_Singh-orange-portait.png" alt="Kirit Singh" width={828} height={828} className="object-cover w-full h-full" />
        </div>
        {/* Text */}
        <div className="flex flex-col items-center max-w-2xl w-full justify-center">
          <h1 className="text-2xl font-extrabold text-[#eb7b55] mb-2 text-center">Kirit like spirit.</h1>
